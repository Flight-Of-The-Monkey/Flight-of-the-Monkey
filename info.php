        ...
        <div class="card-body">
            <fieldset>
                ...
                <hr />
					...
					<div>
		  <h2>kerstvakantie</h2>
			<p>Start: 21 december Eind: 1 january</p>
	</div>
	<div>
		  <h2>voorjaarsvakantie</h2>
			<p>Start: 15 february Eind: 19 february</p>
	</div>
		<div>
		  <h2>goede vrijdag</h2>
			<p>Start: 2 april Eind: 2 april</p>
	</div>
	<div>
		  <h2>tweede paasdag</h2>
			<p>Start: 5 april Eind: 5 april</p>
	</div>
		<div>
		  <h2>koningsdag</h2>
			<p>Start: 27 april Eind: 27 april</p>
	</div>
	<div>
		  <h2>meivakantie</h2>
			<p>Start: 3 mei Eind: 14 mei</p>
	</div>
		<div>
		  <h2>tweedepinksterdag</h2>
			<p>Start: 24 mei Eind: 24 mei</p>
	</div>
	<div>
		  <h2>zomervakantie</h2>
			<p>Start: 19 juli Eind: 27 augustus</p>
	</div>
	</div>
                <p class="two">
...
hvjgvjhvivugvvkjckhchgcugcugvbijjvnajijvdjvadinwaiuvilf
...
Pellentesque commodo eros a enim. Vestibulum turpis sem, aliquet eget, lobortis pellentesque, rutrum OEOEOEOEOEOEOEOEOEOEOEOEOEOEOEOEOEeu, nisl. Sed libero. Aliquam erat volutpat. Etiam vitae tortor. Morbi vestibulum volutpat enim. Aliquam eu nunc. Nunc sed turpis. Sed mollis, eros et ultrices tempus, mauris ipsum aliquam libero, non adipiscing dolor urna a orci. Nulla porta dolor. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos hymenaeos.
